...
\begin{figure}[h]
    ...
    \subfloat[\djpeg: Union vs.\ \honggfuzz]{%
        \includegraphics[width=.5\textwidth]{figures/cropped/djpeg-m-uni-hongg}
    }
    \subfloat[\objdump: Union vs.\ \fairfuzz]{%
        \includegraphics[width=.5\textwidth]{figures/cropped/objdump-m-uni-fair}
    }\\
    \subfloat[\tiffpdf: Union vs.\ \aflfast]{%
        \includegraphics[width=.5\textwidth]{figures/cropped/tiff2pdf-m-uni-afl}
    }
    \subfloat[\listswf: Union vs.\ \fairfuzz]{%
        \includegraphics[width=.5\textwidth]{figures/cropped/ming-m-uni-fair}
    }
