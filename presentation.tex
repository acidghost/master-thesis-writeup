    ...
    \twocols{%
        \begin{center}
            ...
            \smartdiagramadd[flow diagram]
                ...
                above right of module1/Program specification}
...
\begin{frame}
    ...
    \begin{center}
        ...
        \begin{tikzpicture}[%
            box/.style = {%
                bottom color=bg, top color=white, rectangle},
            node distance = 40pt]
            \umlbasiccomponent[bottom color=bg, top color=white]{Fuzzer}
            \node[rectangle, left=of Fuzzer] (inject)
                {\includegraphics[width=1cm]{figures/docs.png}};
            \node[rectangle, right=of Fuzzer] (extract)
                {\includegraphics[width=1cm]{figures/docs.png}};
            ...
            \draw[dashed] (congestion) to (Fuzzer);
        \end{tikzpicture}
    \end{center}
