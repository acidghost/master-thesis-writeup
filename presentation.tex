...
\begin{frame}[label=single-time]{Mean Coverage Over Time}
    ...
    \end{figure}
    \buttons{%
        \hyperlink{single-final<1>}{\beamergotobutton{Jump to final values}}
    }
\end{frame}
...
\begin{frame}[label=coop-time]{Mean Coverage Over Time}
    ...
    \end{figure}
    \buttons{%
        \hyperlink{coop-final<1>}{\beamergotobutton{Jump to final values}}
    }
\end{frame}
...
\begin{frame}[noframenumbering,label=single-final]{Final Mean Coverage for Single Fuzzers}
    ...
    \buttons{%
        \vspace{2\baselineskip}
        \hyperlink{single-time<1>}{\beamerreturnbutton{Return to coverage over time}}
    }
\end{frame}
...
\begin{frame}[noframenumbering,label=coop-final]
    ...
    \buttons{%
        \vspace{2\baselineskip}
        \hyperlink{coop-time<1>}{\beamerreturnbutton{Return to coverage over time}}
    }
\end{frame}
