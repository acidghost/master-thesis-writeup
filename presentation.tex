...
\begin{frame}{Bayesian Estimation of Means}
    \begin{figure}
        \subfloat[\djpeg\\\honggfuzz\ vs.\ \fairfuzz]{%
            \includegraphics[width=.33\textwidth]{figures/cropped/djpeg-m-hongg-fair}
        }
        \subfloat[\objdump\\\fairfuzz\ vs.\ \aflfast]{%
            \includegraphics[width=.33\textwidth]{figures/cropped/objdump-m-fair-afl}
        }
        \subfloat[\tiffpdf\\\aflfast\ vs.\ \fairfuzz]{%
            \includegraphics[width=.33\textwidth]{figures/cropped/tiff2pdf-m-afl-fair}
        }
    \end{figure}
\end{frame}
